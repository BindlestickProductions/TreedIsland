...
{
    class TreedIslandModule
        : public CryHooksModule
    {
    public:
        AZ_RTTI(TreedIslandModule,
            "{64B11EE9-696F-4A5A-90CC-FBD6E4867667}",
            CryHooksModule);
        AZ_CLASS_ALLOCATOR(TreedIslandModule,
...
AZ_DECLARE_MODULE_CLASS(
    TreedIsland_83176372815649969d9127938273d9ad,
    TreedIsland::TreedIslandModule)
