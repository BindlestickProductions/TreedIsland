...
using namespace AZ;
using namespace TreedIsland;

class TreedIslandTest
    : public ::testing::Test
{
protected:
    void SetUp() override
...
TEST_F(TreedIslandTest, MovementHistory_Empty)
{
...
TEST_F(TreedIslandTest, MovementHistory_One)
{
    track->AddDataPoint(Vector3::CreateAxisX(5), 10);
...
TEST_F(TreedIslandTest, MovementHistory_OnSecond)
{
...
TEST_F(TreedIslandTest, MovementHistory_OnFirst)
{
    track->AddDataPoint(Vector3::CreateAxisX(0), 0);
    track->AddDataPoint(Vector3::CreateAxisX(5), 10);
...
TEST_F(TreedIslandTest, MovementHistory_InTheMiddle)
{
    track->AddDataPoint(Vector3::CreateAxisX(0), 0);
...
TEST_F(TreedIslandTest, MovementHistory_InFuture)
{
    track->AddDataPoint(Vector3::CreateAxisX(0), 0);
    track->AddDataPoint(Vector3::CreateAxisX(10), 10);
...
TEST_F(TreedIslandTest, MovementHistory_InThePast)
{
...
TEST_F(TreedIslandTest, MovementHistory_DeleteAll)
{
    track->AddDataPoint(Vector3::CreateAxisX(100), 100);
    track->DeleteAll();
